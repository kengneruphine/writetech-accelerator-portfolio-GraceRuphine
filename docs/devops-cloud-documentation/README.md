# DevOps/Cloud Documentation Project - How to set up CI/CD with Github Actions
...
This is a beginner-friendly documentation which describs how to setup a CI/CD(Continuous Integration and Continuous Development) using Github Actions.
